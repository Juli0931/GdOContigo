          ...
          <form>
            <div className="Selector">
              <button
                ...
                className={selectedOption === "cedula" ? "CedulaBtn Selected" : "CedulaBtn"}
              >
                No. Cédula
              </button>
              <button
                ...
                className={selectedOption === "contrato" ? "ContratoBtn Selected" : "ContratoBtn"}
              >
                No. Contrato
              </button>
            </div>
            <div>
              ...
              <input className="SelectorInput" type="text" placeholder={placeholderText} />
            </div>
            <h3 className="HelpTxt"><span>¿Necesitas ayuda?</span> Mira nuestra guía</h3>
            <button type="button" className="SubmitBtn">Ingresar</button>
          </form>
          </div>
        </div>
